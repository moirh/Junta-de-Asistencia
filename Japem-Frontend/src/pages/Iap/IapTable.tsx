    ...
    <div className="p-6 animate-fade-in relative w-full">
      ...
      <div className="relative flex items-center justify-center mb-8">
        ...
        <div className="text-center">
          <h1 className="text-2xl font-bold text-gray-800">Padrón de Instituciones (IAP)</h1>
          <p className="text-gray-500 mt-1">Gestiona los beneficiarios y sus necesidades.</p>
        </div>
