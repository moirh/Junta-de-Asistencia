...
class SettingsController extends Controller
{
    ...
    public function createUser(Request $request)
    {
        $validated = $request->validate([
            ...
            'role' => 'required|in:superadmin,admin,donativos,asistencial,editor,lector'
        ]);
    ...
    public function updateUser(Request $request, $id)
    {
        ...
        $validated = $request->validate([
            ...
            'role' => 'required|in:superadmin,admin,donativos,asistencial,editor,lector', // Ajusta los roles según tu frontend
